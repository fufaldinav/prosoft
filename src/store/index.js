...
export default new Vuex.Store({
    state: {
        ...
        fields: {
            id: { name: 'ID',  shown: true, width: 6 },
            title: { name: 'Title',  shown: true, width: 12 },
            original_title: { name: 'Original title',  shown: true, width: 12 },
            release_date: { name: 'Release date',  shown: true, width: 10, sortable: true },
            status: { name: 'Status',  shown: true, width: 8, sortable: true },
            production_countries: { name: 'Countries',  shown: true, width: 12 },
            tagline: { name: 'Tagline',  shown: true, width: 10 },
            genres: { name: 'Genres',  shown: true, width: 10 },
            budget: { name: 'Budget',  shown: true, width: 8, sortable: true },
            revenue: { name: 'Revenue',  shown: true, width: 8, sortable: true },
            adult: { name: 'Adult',  shown: true, width: 6 },
            belongs_to_collection: { name: 'Collection',  shown: true, width: 12 },
            homepage: { name: 'Homepage',  shown: true, width: 8 },
            imdb_id: { name: 'IMDB',  shown: true, width: 6, sortable: true },
            original_language: { name: 'Original language',  shown: true, width: 12, sortable: true },
            spoken_languages: { name: 'Language',  shown: true, width: 12 },
            overview: { name: 'Overview',  shown: true, width: 16 },
            production_companies: { name: 'Production Co',  shown: true, width: 12 },
            runtime: { name: 'Runtime',  shown: true, width: 8, sortable: true },
            popularity: { name: 'Popularity',  shown: true, width: 10, sortable: true },
            vote_average: { name: 'Vote average',  shown: true, width: 10, sortable: true },
            vote_count: { name: 'Vote count',  shown: true, width: 10, sortable: true },
        },
        sortField: null,
        sortOrder: 'asc',
        filters: {
